                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-sm-10">
                                    <label class="custom-control custom-radio custom-control-inline">
                                         <input type="radio" class="custom-control-input{{ $errors->has('keterangan') ? ' is-invalid' : '' }}" name="keterangan" value="simpanan pokok"{!! old('keterangan') == 'p' ? ' checked=""' : '' !!}>
                                         <span class="custom-control-label">Simpanan Pokok</span>
                                     </label>
                                     <label class="custom-control custom-radio custom-control-inline">
                                         <input type="radio" class="custom-control-input{{ $errors->has('keterangan') ? ' is-invalid' : '' }}" name="keterangan" value="simpanan wajib"{!! old('keterangan') == 'w' ? ' checked=""' : '' !!}>
                                         <span class="custom-control-label">Simpanan Wajib</span>
                                     </label>
